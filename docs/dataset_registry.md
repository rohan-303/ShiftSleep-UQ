...
| ISRUC-Sleep | ISRUC official site; DOI 10.1016/j.cmpb.2015.10.013; NEMAR v1.0.1 metadata | public metadata verified; local representative metadata acquired | S1: 100 subjects; S2: 8 subjects/16 sessions; S3: 10 subjects | 126 NEMAR scans | S1 exact inventory includes C3-A2, LOC-A2 and six EEG/two EOG/three EMG labels; 200 Hz representative rate | two experts; scorer 1 is primary NEMAR event stream, scorer 2 retained as extras | CORE_S1_VERIFIED; S2/S3 secondary | S2 session 2 uses M1/M2 montage; no silent cross-cohort fallback |
|| Sleep Heart Health Study (SHHS) | NSRR official page; DOI 10.25822/ghy8-ks59 | public schema verified; raw access pending account/terms | 6,441 Visit 1 enrollment; 3,295 repeat participants | raw EDF counts documented by NSRR; final acquired count pending | intended SHHS1 C3-A2 EEG 125 Hz and EOG(L)-PG1 50 Hz; per-record deviations must be validated | XML stream pending authorized raw audit | PLANNED_PRIMARY_DOMAIN_PENDING_RAW_ACCESS | not acquired; repeated visits must remain grouped |
